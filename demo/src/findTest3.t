...
AutoTest
	...
	autoTestSilent = true
	autoTestStartGame() {
		// Place alice and the pebble in random rooms.
		...
		alice.explore('foo', bind(&exploreDone, self));
	...
	// Called when the explore agenda runs out of unvisited rooms.
	exploreDone(v?) {
		// Now tell alice to find the pebble.  She should now have
		// a memory of the location.
